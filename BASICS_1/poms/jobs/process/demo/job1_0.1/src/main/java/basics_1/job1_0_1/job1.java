...
/**
 * Job: job1 Purpose: abcd<br>
 * Description: <br>
 * 
 * @author Kalvacherla, Sai Venkat Krishna
...
public class job1 implements TalendJob {
	...
	private final String projectName = "BASICS_1";
	...
	public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
		final static byte[] commonByteArrayLock_BASICS_1_job1 = new byte[0];
		static byte[] commonByteArray_BASICS_1_job1 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_BASICS_1_job1.length) {
					if (length < 1024 && commonByteArray_BASICS_1_job1.length == 0) {
						commonByteArray_BASICS_1_job1 = new byte[1024];
					} else {
						commonByteArray_BASICS_1_job1 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_BASICS_1_job1, 0, length);
				strReturn = new String(commonByteArray_BASICS_1_job1, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_BASICS_1_job1, 0, length);
				strReturn = new String(commonByteArray_BASICS_1_job1, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_BASICS_1_job1) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		mdc("tFileInputDelimited_1", "Rcw7Q0_");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				props_tDBOutput_1.setValue("useDBMappingFile", false);
				...
				props_tDBOutput_1.connection.setValue("account", "GLESLLB-SL23333");
				...
				props_tDBOutput_1.connection.setValue("db", "CUSTOMER_DB");

				props_tDBOutput_1.connection.setValue("schemaName", "CUSTOMER_SCHEMA");
				...
				props_tDBOutput_1.connection.userPassword.setValue("userId", "SAIVENKAT");

				props_tDBOutput_1.connection.userPassword.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:R10P+onCCk+7kOI4QYqhxNzn1CetmriF6uXsd7InryptKH/kUOkA5M2d"));

				props_tDBOutput_1.connection.referencedComponent.setValue("referenceDefinitionName",
						"tSnowflakeConnection");

				props_tDBOutput_1.table.setValue("tableName", "CUSTOMERS");

				props_tDBOutput_1.table.connection.setValue("loginTimeout", 15);

				props_tDBOutput_1.table.connection.setValue("account", "GLESLLB-SL23333");
				...
				props_tDBOutput_1.table.connection.setValue("db", "CUSTOMER_DB");

				props_tDBOutput_1.table.connection.setValue("schemaName", "CUSTOMER_SCHEMA");
				...
				props_tDBOutput_1.table.connection.userPassword.setValue("userId", "SAIVENKAT");

				props_tDBOutput_1.table.connection.userPassword.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:8zB6epiCIBAO2I5GRUpKH63DVMbUZcica/FXnGfMlWe0CoxCtVDR/fXF"));
				...
				class SchemaSettingTool_tDBOutput_1_2_fisrt {
					...
					String getSchemaValue() {
						...
						a("\"name\":\"cust_id\",\"type\":[\"int\",\"null\"],\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"cust_id\",\"di.column.talendType\":\"id_Integer\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"cust_id\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"first_name\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"first_name\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"first_name\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"last_name\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"last_name\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"last_name\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"email\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"email\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"email\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"city\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"city\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"city\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"country\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"country\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"country\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"full_name\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"full_name\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"full_name\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"tDBOutput_1\",\"di.table.label\":\"tDBOutput_1\"}",
								s);
...
// ###############################
					...
					class BytesLimit65535_tFileInputDelimited_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileInputDelimited_1
									.append("FILENAME" + " = " + "\"D:/Talend_Installation/Data/customers.csv\"");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							...
							log4jParamters_tFileInputDelimited_1.append("TRIMSELECT" + " = " + "[{TRIM=" + ("false")
									+ ", SCHEMA_COLUMN=" + ("cust_id") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN="
									+ ("first_name") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("last_name")
									+ "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("email") + "}, {TRIM=" + ("false")
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "D:/Talend_Installation/Data/customers.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"D:/Talend_Installation/Data/customers.csv", "ISO-8859-15", ",", "\n", true, 0, 0,
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											...
											"cust_id", "row1", temp, ex_tFileInputDelimited_1),
...
// Start of branch "out1"
							if (out1 != null) {
								...
								if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1
										.getRuntimeSchema().getField("cust_id") != null) {
									incomingEnforcer_tDBOutput_1.put("cust_id", out1.cust_id);
								}
								// skip the put action if the input column doesn't appear in component runtime
								// schema
								if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1
										.getRuntimeSchema().getField("first_name") != null) {
									incomingEnforcer_tDBOutput_1.put("first_name", out1.first_name);
								}
								// skip the put action if the input column doesn't appear in component runtime
								// schema
								if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1
										.getRuntimeSchema().getField("last_name") != null) {
									incomingEnforcer_tDBOutput_1.put("last_name", out1.last_name);
								}
								// skip the put action if the input column doesn't appear in component runtime
								// schema
								if (incomingEnforcer_tDBOutput_1 != null
										&& incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("email") != null) {
								...
								// schema
								if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1
										.getRuntimeSchema().getField("country") != null) {
									incomingEnforcer_tDBOutput_1.put("country", out1.country);
								}
								// skip the put action if the input column doesn't appear in component runtime
								// schema
								if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1
										.getRuntimeSchema().getField("full_name") != null) {
					...
					if (!((Object) ("D:/Talend_Installation/Data/customers.csv") instanceof java.io.InputStream)) {
...
// finally of generic
	...
	private void readJobInfo(java.io.File jobInfoFile) {
		...
		log.info(String.format("Project name: %s\tJob name: %s\tGIT Commit ID: %s\tTalend Version: %s", projectName,
				jobName, jobInfo.getProperty("gitCommitId"), "8.0.1.20250423_1207-patch"));
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_R44aICvcEfCzrL3wcC1N9Q");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2025-05-08T09:27:44.589824200Z");
		...
		try {
			...
			java.io.InputStream inContext = job1.class.getClassLoader()
					.getResourceAsStream("basics_1/job1_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 123607 characters generated by Talend Cloud Data Management Platform on the 8
 * May 2025 at 2:57:44 pm IST
 ************************************************************************************************/